...
export default function ProductGrid() {
  ...
  const handleBuyNow = async (id: string | number) => {
    // Navigate via our new API endpoint which handles the RPC rotation and redirects securely
          ...
          <div className="flex flex-wrap gap-2">
            {categories.map(cat => (
              <button 
                ...
                className={`px-6 py-2 rounded-full font-body text-[10px] font-bold transition-all ${
                  activeCategory === cat 
