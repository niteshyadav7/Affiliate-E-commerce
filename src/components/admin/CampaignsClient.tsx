...
export default function CampaignsClient() {
  const [subject, setSubject] = useState(
    "Exclusive Weekly Deals from Diversified Y&P!",
  );
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-on-secondary-container mt-2">
            Create custom weekly broadcasts, monitor subscriptions, and view
            email styling.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <form
            ...
            className="bg-white p-6 rounded-3xl border border-surface-container-low shadow-sm space-y-5"
          >
            <div className="flex justify-between items-center pb-4 border-b border-surface-container-low">
              <div>
                ...
                <p className="text-[11px] text-on-secondary-container opacity-70 mt-0.5">
                  Dispatches a weekly deal digest to your mailing list.
                </p>
              </div>
            ...
            <div className="pt-2">
              <Button
                ...
                disabled={
                  sending || loadingSubscribers || subscribers.length === 0
                }
              >
          ...
          <div className="bg-white p-6 rounded-3xl border border-surface-container-low shadow-sm space-y-4">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-3 pb-3 border-b border-surface-container-low">
              <div>
                ...
                <p className="text-[11px] text-on-secondary-container opacity-70">
                  View and manage newsletter audience.
                </p>
              </div>
            ...
            {loadingSubscribers ? (
              <div className="text-center py-6 text-xs text-on-secondary-container opacity-60">
                Loading list...
              </div>
        ...
        <div className="lg:col-span-5 flex flex-col items-center space-y-3">
          <h4 className="text-xs font-bold text-primary flex items-center gap-1.5 uppercase tracking-wider">
            <Smartphone className="w-4 h-4 text-primary" /> Live Mobile Email
            Preview
          </h4>
            ...
            <div className="flex-1 bg-gray-100 rounded-[28px] overflow-hidden flex flex-col border border-slate-900/10">
              ...
              <div className="bg-white p-3 border-b border-gray-100 flex-shrink-0 text-[10px] space-y-1">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-400 text-[8px] whitespace-nowrap">
                    9:41 AM
                  </span>
                </div>
                <div className="text-[8px] text-gray-400">
                  ...
                  <span className="text-gray-600 font-semibold">
                    yadavgolu178@gmail.com
                  </span>
                </div>
                <div className="text-[8px] text-gray-400">
                  To:{" "}
                  <span className="text-gray-600 font-semibold">
                    newsletter-subscribers@diversified-y-p
                  </span>
                </div>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-2.5 text-[9px] bg-white space-y-4">
                ...
                <div className="text-center border-b border-gray-50 pb-2">
                  ...
                  <div className="text-[8px] text-gray-400 mt-0.5">
                    Your curated shopping rotation
                  </div>
                </div>
                      ...
                      {products.map((p, idx) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="font-bold text-gray-800 truncate text-[9px]">
                              {p.name}
                            </div>
                            <div className="text-[8px] text-gray-400 truncate line-clamp-1">
                              {p.description}
                            </div>
                          </div>
                          <div className="text-right whitespace-nowrap pl-1">
                            <div className="font-bold text-green-600 text-[9px]">
                              {p.price}
                            </div>
                            <span className="text-[7px] bg-primary text-white font-bold px-1.5 py-0.5 rounded mt-0.5 inline-block">
                              Shop
                            </span>
                          </div>
                        </div>
                ...
                <div className="border-t border-gray-100 pt-3 text-center text-gray-400 text-[8px] space-y-1 pb-4">
                  <p>
                    You are receiving this because you subscribed to Diversified
                    Y&P updates.
                  </p>
